...
public class WrongsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.wrongs_fragment_layout, container, false);
        ...
        RecyclerView questionRecyclerView = rootView.findViewById(R.id.wrongs_recycler_view);
        ...
        leitnerViewModel.getWrongs().observe(this, new Observer<List<LeitnerEntity>>() {
            @Override
            public void onChanged(List<LeitnerEntity> leitnerEntities) {
//                questionAdapter.updateList(leitnerEntities);
